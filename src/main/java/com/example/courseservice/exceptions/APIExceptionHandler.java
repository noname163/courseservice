...
import com.example.courseservice.data.dto.response.ExceptionResponse;
...
public class APIExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleMediaUploadException(MediaUploadException ex) {
        ExceptionResponse errors = ExceptionResponse.builder().message(ex.getMessage()).build();
        return new ResponseEntity<>(errors, HttpStatus.BAD_REQUEST);
    }
