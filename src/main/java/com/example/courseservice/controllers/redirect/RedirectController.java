...
public class RedirectController {
    ...
    @ResponseBody
    public ModelAndView transactionPage(@RequestParam(value = "vnp_TxnRef") String vnpTxnRef,
        ...
        return new ModelAndView("redirect:" + environmentVariable.getVnPayRedirectUrl());
    }
}
