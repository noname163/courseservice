...
public class CourseTemporaryMapper {
    ...
    public CourseTemporary mapUpdateTemporaryToCourseTemporary(CourseTemporaryUpdateRequest courseTemporaryUpdateRequest, CourseTemporary courseUpdateRequest){
        courseUpdateRequest.setName(Optional.ofNullable(courseTemporaryUpdateRequest.getName()).orElse(courseUpdateRequest.getName()));
        courseUpdateRequest.setDescription(Optional.ofNullable(courseTemporaryUpdateRequest.getDescription()).orElse(courseUpdateRequest.getDescription()));
        courseUpdateRequest.setLevelId(Optional.ofNullable(courseTemporaryUpdateRequest.getLevelId()).orElse(courseUpdateRequest.getLevelId()));
        courseUpdateRequest.setPrice(Optional.ofNullable(courseTemporaryUpdateRequest.getPrice()).orElse(courseUpdateRequest.getPrice()));
        courseUpdateRequest.setSubject(Optional.ofNullable(courseTemporaryUpdateRequest.getSubject().getName()).orElse(courseUpdateRequest.getSubject()));
        courseUpdateRequest.setSubjectId(Optional.ofNullable(courseTemporaryUpdateRequest.getSubject().getId()).orElse(courseUpdateRequest.getSubjectId()));
